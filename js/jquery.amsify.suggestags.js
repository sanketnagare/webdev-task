    ...
    $.fn.amsifySuggestags = function(options, method) {
        ...
        AmsifySuggestags.prototype = {
            ...
            printValues : function() {
              ...
              let arr = (this.tagNames, $(this.selector).val());
              console.info (this.tagNames);
        ...
        return this.each(function() {
          window.amsifySuggestagsInstance = new AmsifySuggestags();
          window.amsifySuggestagsInstance._init(this);
